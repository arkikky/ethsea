  ...
  return (
    <>
      <header className="overflow-hidden relative mb-14 sm:mb-24 xl:mb-32 pt-[125px] sm:pt-[187px] h-auto w-full">
        ...
        <div className="absolute inset-y-0 sm:top-0 sm:bottom-[auto] left-auto -right-[145px] sm:-right-[289px] lg:-right-[235px] xl:right-0 h-[487px] sm:h-auto sm:w-full max-w-[369px] sm:max-w-[738px] lg:max-w-[740px] xl:max-w-[731px] -z-px">
          <Image
            className="object-bottom object-cover h-full w-full"
            ...
            <div className="inline-flex flex-col sm:flex-row items-center flex-wrap mt-8 w-full">
              ...
              >
                <span className="flex flex-row">
                  <svg
                    className="mr-1.5 h-4.5 sm:h-6 w-4.5 sm:w-6"
                    viewBox="0 0 22 24"
                    fill="none"
